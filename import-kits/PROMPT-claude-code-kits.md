...
- `kits.json` : les 63 kits, leurs lignes, les 147 références produits qu'ils utilisent, et les séries à venir
- `SacAdo_kits_v7.xlsx` : la même chose en tableur, pour l'équipe. Ne l'utilise pas pour l'import.
