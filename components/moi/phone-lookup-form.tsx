...
export function PhoneLookupForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 rounded-2xl border border-ink/10 bg-elevated p-3">
      ...
      <button
        type="submit"
        className="self-start rounded-full bg-brand px-4 py-2 text-sm font-semibold text-on-brand active:scale-95"
      >
